...
export default function UpdateAddNewProduct() {
  ...
  return (
    <div className="w-full min-h-screen bg-primary flex justify-center items-center p-8 font-sans">
      <div className="w-full max-w-3xl bg-white/70 backdrop-blur-xl rounded-[40px] shadow-2xl shadow-secondary/10 border border-white p-10 lg:p-14">
        ...
        {/* Header Section */}
        <div className="mb-10">
          <h1 className="text-secondary text-4xl font-serif italic tracking-tight">Update Creation</h1>
          <p className="text-gray-500 text-sm mt-2 font-light">Update the new masterpiece to the LuxeGlow collection.</p>
        </div>
